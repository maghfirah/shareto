...
/* harmony export */   "DashboardIndexComponent": function() { return /* binding */ DashboardIndexComponent; }
/* harmony export */ });
...
/* harmony import */ var src_app_shared_enum_transaction_status__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/shared/enum/transaction-status */ 16486);
/* harmony import */ var src_app_shared_constant_api_constant__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/shared/constant/api.constant */ 58412);
/* harmony import */ var src_environments_environment__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/environments/environment */ 92340);
/* harmony import */ var src_app_shared_models_response_api_model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/shared/models/response-api.model */ 5320);
/* harmony import */ var src_app_shared_constant_api_error_code_constant__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/shared/constant/api-error-code.constant */ 96694);
/* harmony import */ var src_app_shared_constant_error_code_constant__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/shared/constant/error-code.constant */ 28228);
...
/* harmony import */ var src_app_shared_service_request_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/shared/service/request.service */ 67229);
/* harmony import */ var src_app_shared_service_error_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/shared/service/error.service */ 38205);
...
function DashboardIndexComponent_div_0_Template(rf, ctx) { if (rf & 1) {
...
function DashboardIndexComponent_ng_template_1_ng_container_0_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵlistener"]("click", function DashboardIndexComponent_ng_template_1_ng_container_0_Template_a_click_18_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵrestoreView"](_r5); const ctx_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵnextContext"](2); return ctx_r4.goToTransactionPage(ctx_r4.transactionStatus.checkWaitingForPayment); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵlistener"]("click", function DashboardIndexComponent_ng_template_1_ng_container_0_Template_a_click_28_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵrestoreView"](_r5); const ctx_r6 = _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵnextContext"](2); return ctx_r6.goToTransactionPage(ctx_r6.transactionStatus.checkNewOrder); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵlistener"]("click", function DashboardIndexComponent_ng_template_1_ng_container_0_Template_a_click_38_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵrestoreView"](_r5); const ctx_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵnextContext"](2); return ctx_r7.goToTransactionPage(ctx_r7.transactionStatus.checkProccessed); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵlistener"]("click", function DashboardIndexComponent_ng_template_1_ng_container_0_Template_a_click_48_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵrestoreView"](_r5); const ctx_r8 = _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵnextContext"](2); return ctx_r8.goToTransactionPage(ctx_r8.transactionStatus.checkSent); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵlistener"]("click", function DashboardIndexComponent_ng_template_1_ng_container_0_Template_a_click_58_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵrestoreView"](_r5); const ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵnextContext"](2); return ctx_r9.goToTransactionPage(ctx_r9.transactionStatus.checkFinished); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵlistener"]("click", function DashboardIndexComponent_ng_template_1_ng_container_0_Template_button_click_73_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵrestoreView"](_r5); const ctx_r10 = _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵnextContext"](2); return ctx_r10.changePage("add"); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵlistener"]("click", function DashboardIndexComponent_ng_template_1_ng_container_0_Template_a_click_99_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵrestoreView"](_r5); const ctx_r13 = _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵnextContext"](2); return ctx_r13.goToOrderPage(); });
...
function DashboardIndexComponent_ng_template_1_Template(rf, ctx) { if (rf & 1) {
...
class DashboardIndexComponent {
    constructor(router, requestService, errorService) {
        this.router = router;
    ...
    goToTransactionPage(status) {
        this.router.navigate(['/' + _shared_constant_navigation_constant__WEBPACK_IMPORTED_MODULE_0__.NavigationConstant.ROUTING_TRANSACTION], { queryParams: { status: status } });
    }
    changePage(pageName) {
        this.router.navigate(['/' + _shared_constant_navigation_constant__WEBPACK_IMPORTED_MODULE_0__.NavigationConstant.ROUTING_INVENTORY], { queryParams: { pageName: 'add' }, skipLocationChange: true, replaceUrl: true });
    }
    getDataDashboard() {
        let ENDPOINT_DASHBOARD = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__.environment.apiUrl + src_app_shared_constant_api_constant__WEBPACK_IMPORTED_MODULE_2__.APIConstant.MERCHANT_DASHBOARD;
        let requestParam = new Map();
        this.requestService.get(ENDPOINT_DASHBOARD, requestParam).subscribe((response) => {
            this.dashboardData = response;
            this.loading = false;
        }, (error) => {
            this.responseApi = error.error;
            if (this.responseApi.error.code === src_app_shared_constant_api_error_code_constant__WEBPACK_IMPORTED_MODULE_5__.ApiErrorCode.MERCHANT_NOT_FOUND) {
                this.router.navigate([_shared_constant_navigation_constant__WEBPACK_IMPORTED_MODULE_0__.NavigationConstant.ERROR_CUSTOM, src_app_shared_constant_error_code_constant__WEBPACK_IMPORTED_MODULE_6__.ErrorCodeConstant.KYB]);
            }
            else if (this.responseApi.error.code === src_app_shared_constant_api_error_code_constant__WEBPACK_IMPORTED_MODULE_5__.ApiErrorCode.MERCHANT_INACTIVE) {
                this.router.navigate([_shared_constant_navigation_constant__WEBPACK_IMPORTED_MODULE_0__.NavigationConstant.ROUTING_CONFIGURATION]);
            }
            else {
...
DashboardIndexComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineComponent"]({ type: DashboardIndexComponent, selectors: [["app-dashboard-index"]], decls: 3, vars: 2, consts: [[4, "ngIf", "ngIfElse"], ["loaded", ""], [1, "center"], ["role", "status", 1, "spinner-border", "text-primary", "spinner-sm", "mr-5"], [4, "ngIf"], [1, "row"], [1, "form-group", "col-md-12", "page-header"], [1, "card", "mb-5"], [1, "card-body"], [1, "col"], [1, "col-md", "col-sm-12", "summary-transaction", "summary-border"], [1, "card"], [3, "click"], [1, "row", "m-0"], [1, "col-md", "col-sm-12", "summary-transaction"], [1, "row", "mb-3", 2, "align-items", "center"], [1, "col-md-auto", "col"], [1, "btn", "btn-outline-danger", 3, "click"], [1, "fas", "fa-plus"], [1, "col-md", "col-sm-12", "summary-product", "summary-border"]], template: function DashboardIndexComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var _dashboard_index_dashboard_index_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dashboard-index/dashboard-index.component */ 95118);
...
DashboardModule.ɵinj = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ imports: [[
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](DashboardModule, { declarations: [_dashboard_index_dashboard_index_component__WEBPACK_IMPORTED_MODULE_0__.DashboardIndexComponent], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__.CommonModule, _angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule, _angular_forms__WEBPACK_IMPORTED_MODULE_4__.ReactiveFormsModule,
        _angular_forms__WEBPACK_IMPORTED_MODULE_4__.FormsModule,
        _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_5__.NgbTooltipModule] }); })();
...
//# sourceMappingURL=src_app_modules_dashboard_dashboard_module_ts-es2015.js.map